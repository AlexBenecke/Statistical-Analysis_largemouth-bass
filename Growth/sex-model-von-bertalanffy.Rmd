---
title: "sex-model-von-bertalanffy"
...
```{ Load sexmod.lkt, include=FALSE}
load("model-output/sexmod.lkt.rda")
```
```{ Results of sexmod.lkt, echo=FALSE}
...
### {$L_{\infty}, K} Sex Model, {sexmod.lk}
  ...
  Unfortunaltly, I do think this is the sex model that would make the most sense biologically except for maybe the $L_{\inft}$ of K sex models.


```{ L and K Sex Model, eval=FALSE}
