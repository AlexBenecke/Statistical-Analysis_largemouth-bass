...
```
  ...
  Looks like Wr is different between years (One-Way ANOVA, $F_{2, 311}$ = 5.04, p = 0.007). There is no difference in relative weight between 2015 and 2014 (Tukey HSD, t = 0.1, p = 0.99). However, relative weight is significantly different between 2016 and 2014 (Tukey HSD, t = 2.98, p = 0.009), and 2016 and 2015 (Tukey HSD, t = 2.36, p = 0.049).
