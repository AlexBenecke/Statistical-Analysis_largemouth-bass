...
str(pred)
head(pred)
#1-10-2018#write.csv(pred,file = "Data/Clean-Data/relative-weight_largemouth-bass_STOCK.csv")
```
...
```
  ...
  Looks like relative weight *is significantly different* between years (One-Way ANOVA, $F_{2, 311}$ = 5.04, p = 0.007). There is *no significant difference* in relative weight between 2014 and 2015 (Tukey HSD, t = 0.1, p = 0.994). However, relative weight *is significantly different* between 2014 and 2016 (Tukey HSD, t = 2.98, p = 0.009), and 2015 and 2016 (Tukey HSD, t = 2.36, p = 0.049).
