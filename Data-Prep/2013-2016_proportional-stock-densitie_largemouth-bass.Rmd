...
PSD <- read.csv("Data/Clean-Data/2012-2016_nearshore-survey-largemouth-bass_Stock_CLEAN.csv")  %>%
  filter(Year>=2013) %>%
...
```{r Create length bins, tidy=TRUE, results='hide'}
...
### Calculate PSD-X and 95% CI 2013 - 2016 
...
### Create Data Frame containing PSD-X and 95% CI for all years 2013 - 2016
...
PSD.Q
#1-4-18#write.csv(PSD.Q, file="Data/Clean-Data/PSD-Q.csv")
```
...
#1-4-18#write.csv(PSD.P, file="Data/Clean-Data/PSD-P.csv")
```
