...
PSD <- read.csv("Data/Clean-Data/lmb-cpe.csv")  %>%
...
#        species = "Largemouth Bass",
#        what = "traditional"))
#save(PSD_CI_17,file = "model-output/PSD_CI_17.rda")
```
...
PSD.Q
#1-30-2018#write.csv(PSD.Q, file="Data/Clean-Data/PSD-Q.csv",row.names = FALSE)
```
...
#1-30-2018#write.csv(PSD.P, file="Data/Clean-Data/PSD-P.csv", row.names = FALSE)
```
