...
headtail(lmb)
#2-8-2018#write.csv(lmb,file="Data/Clean-Data/largemouth-bass_Wr_NS.csv", row.names = FALSE) 
```
...
#2-8-2018#write.csv(Stock,file="Data/Clean-Data/largemouth-bass_Wr_Stock.csv", row.names = FALSE)
```
...
#2-8-2018#write.csv(Wr.fyr.gcat_Stock,file = "Data/Clean-Data/summary-data/relative-weight_largemouth-bass_STOCK_Summary.csv", row.names = FALSE)
```
...
#2-8-2018#write.csv(lmb.Wr.gcat,file = "Data/Clean-Data/summary-data/relative-weight_largemouth-bass_150_Summary.csv", row.names = FALSE)
```
