...
| Year  | Number of Fish | Number of Sites |
|:-----:|:--------------:|:---------------:|
| 2013  |      114       |         8       |
| 2014  |      143       |        11       |
| 2015  |       80       |         9       |
...
#1-4-18#write.csv(Wr.fyr.gcat_Stock,file = "Data/Raw-Data/relative-weight_largemouth-bass_STOCK_RAW.csv")
```
...
#1-4-18#write.csv(lmb.Wr.gcat,file = "Data/Clean-Data/relative-weight_largemouth-bass_150.csv")
```
