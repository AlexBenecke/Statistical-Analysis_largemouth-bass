...
---
  ...
  I will now compare the length frequency distribution for largemouth bass obtained in the nearshore electrofishing survey during 2014 - 2016.
...
```
  ...
  Now I want to separate out the years.
...
par(mfrow=c(4,1)) ### arrange graphs 1 column 3 rows
par(mfrow=c(2,2))
...
```
```{r Make Adjuster p-values a little easier to read}
