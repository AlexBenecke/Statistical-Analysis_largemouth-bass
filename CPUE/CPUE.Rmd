...
## Results $H_0$ 1 ##
  ...
  There is *no significant difference* in CPUE between years ($F_{1,40}$ = 0.071, p = 0.792).
...
## Results $H_0$ 2 ##
  ...
  There is *no significant difference* in CPUE for fish > Quality length (300mm) among years 2013 - 2016 ($F_{1,40}$ = 0.515, p = 0.477).
...
## Results $H_0$ 3 ##
  ...
  There is *no significat difference* in CPUE for fish < Quality length among years 2013 - 2016 ($F_{1,40}$ = 0.014, p = 0.906).
